...
export default function AdminLoginPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    // signInWithOAuth navigates the window — only get here on error
    if (error) {
      setLoading(false);
      toast.error(error.message);
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md card">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-brand-navy">It's Always Fun, LLC</h1>
        ...
        <button
          ...
          disabled={loading}
          className="w-full inline-flex items-center justify-center gap-2 border border-slate-300 bg-white text-slate-700 font-medium py-2.5 rounded-md hover:bg-slate-50 transition disabled:opacity-50 mb-4"
        >
