...
def render(api):
    ...
    api['add_kv_table'](doc,
        ...
        [
            ...
            ('Uptime — /api/health', 'UptimeRobot monitor 803176669', 'LIVE 2026-06-18, 5-min interval, email alerts'),
            ('Uptime — beta cron',   'UptimeRobot (1-hour interval)', '/api/cron/beta-lifecycle-status wired 2026-06-18. Returns 503 + pages Ludmila when active beta tenants exist but no lifecycle email fired in the last 25h (cron wedged)'),
